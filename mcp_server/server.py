...
def _db_path() -> Path:
    return Path(os.getenv("RADAR_DB_PATH", "data/radar.duckdb"))
...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        {
            "name": "search",
            "description": "Search policy changes and regulations.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string"},
        ...
        {
            "name": "recent_updates",
            "description": "List recently collected policy articles from DuckDB.",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "top_trends",
            "description": "Show top entity frequencies from recent policy article matches.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "days": {"type": "integer", "minimum": 1},
