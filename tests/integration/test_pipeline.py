...
<item>
  <title>Policy market update</title>
  <link>https://example.com/article-1</link>
  <description>policy update is out</description>
  <pubDate>Wed, 04 Mar 2026 10:00:00 GMT</pubDate>
</item>
</channel></rss>
"""

    with patch("policyradar.collector.requests.Session.get", return_value=_FakeResponse(rss_payload)):
        output_path = run(
            category="test_cat",
