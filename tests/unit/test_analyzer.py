...
Article = cast(_ArticleCtor, import_module("policyradar.models").Article)
EntityDefinition = cast(_EntityCtor, import_module("policyradar.models").EntityDefinition)
apply_entity_rules = cast(_ApplyEntityRules, import_module("policyradar.analyzer").apply_entity_rules)
