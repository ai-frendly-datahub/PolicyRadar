...
from policyradar.collector import RateLimiter, _collect_single, collect_sources
...
class TestCollectorRetryLogic:
    ...
    def test_retry_on_timeout(self) -> None:
        ...
        with patch("policyradar.collector.requests.get") as mock_get:
            mock_response = Mock()
...
<rss version="2.0">
    ...
    def test_session_reuse(self) -> None:
        ...
        with (
            patch("policyradar.collector.requests.Session.get") as mock_get,
            patch("policyradar.collector.get_circuit_breaker_manager", return_value=mock_manager),
        ):
            mock_response = Mock()
            mock_response.content = b"""<?xml version="1.0"?>
<rss version="2.0">
